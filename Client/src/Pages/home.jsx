  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Hero */}
        <div
          className={`text-center mb-6 sm:mb-10 transition-all duration-500 transform ${
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-7">
          {filteredProducts.length > 0 ? (
            ...
            <div
              className={`col-span-full text-center py-6 sm:py-10 transition-all duration-500 transform ${
                animate
                  ? "translate-y-0 opacity-100"
                  : "translate-y-4 opacity-0"
              }`}
